...
class PostController:
    def all_posts(self):
        ...
        return generate_response(
            data=[post.to_json() for post in posts], status_code=HTTP_200_OK
        )
    ...
    def feed(self):
        ...
        return generate_response(
            data=posts, message="User feed", status_code=HTTP_200_OK
        )
    ...
    def get_post(self, post_id):
        ...
        return generate_response(
            data=post.to_json(), message="Post", status_code=HTTP_200_OK
        )
